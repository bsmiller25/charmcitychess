...
# tournament
tname = 'Charm City Chess Club 2023 December Open Tournament'
tdate = datetime.datetime.strptime('2023-12-03', '%Y-%m-%d').date()
edate = datetime.datetime.strptime('2023-11-25', '%Y-%m-%d').date()
