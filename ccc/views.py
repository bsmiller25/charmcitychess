...
# tournament
tname = 'Charm City Chess Club 2023 Fall Action Tournament'
tdate = datetime.datetime.strptime('2023-09-10', '%Y-%m-%d').date()
edate = datetime.datetime.strptime('2023-09-03', '%Y-%m-%d').date()
